...
\documentclass[11pt,
  ...
  % Last language is the preferred one. ngerman
  ]{scrbook}
...
%%%%
%% Added for numbering of equations
\usepackage{amsmath, amsfonts,amssymb}
%\usepackage{subfigure}
% \usepackage[algosection ,lined, ruled, algo2e, linesnumbered]{algorithm2e} % tHIS

% \usepackage[algosection,linesnumbered,lined, ruled]{algorithm2e}
%\usepackage[algosection,linesnumbered,lined, ruled]{algorithm2e}
%% added by panku
\usepackage[normalem]{ulem}
\newcommand{\ps}[1] {\noindent \textcolor{red}{{ }{\em #1}} }
...
\usepackage{titling}
% Global Localization using Traffic Sign Landmarks for Autonomous Driving in Urban Scenarios
\title{Design and Implementation of a Configurable Generic Search Engine Indexing using Scalable Crawlers​}
\author{Alhajras Algdairy}

% Change to your first examiner
% The ~ enables non sentence spacing after a period
\newcommand{\firstexaminer}{Prof.~Dr.~Hannah Bast}
...
\newcommand{\secondexaminer}{Prof.~Dr.~Thomas Brox}
% Change to your adivers
\newcommand{\advisers}{M. Sc. Natalie Prange}
